# Sprint 21 — Rotina docente e agenda infantil

## Objetivo

Completar chamadas com conteúdo ministrado, oferecer atividades individuais e coletivas com
resultado final por aluno e criar a agenda diária da Educação Infantil.
...
- [x] Agenda redesenhada como listagem canônica com editor expansível e salvamento atômico da
  turma inteira.
- [x] Humor, Descanso, Evacuação e Participação estruturados com catálogo fixo e ativação escolar.
- [x] Alimentação em botões segmentados, incluindo `NOT_PRESENT`, com rótulos Café da manhã,
