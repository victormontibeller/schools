...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='city',
            index=models.Index(fields=['ibge_code'], name='locations_c_ibge_co_cdae13_idx'),
        ),
        migrations.AddConstraint(
            model_name='city',
            constraint=models.UniqueConstraint(fields=('state', 'name'), name='uniq_locations_city_state_name'),
        ),
    ]
