...
class _OrganizationForm(forms.Form):
    """Campos institucionais compartilhados por escola e unidades."""
...
class BusinessUnitForm(_OrganizationForm):
    """Formulario de criacao e edicao de unidades de negocio."""


class SchoolEditForm(_OrganizationForm):
