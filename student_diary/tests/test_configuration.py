...
@pytest.mark.django_db
def test_update_aspect_edits_fixed_item_and_detects_stale_version(user):
    ...
    assert updated.code == DiaryCategory.Aspect.MOOD
...
@pytest.mark.django_db
def test_update_and_toggle_option_preserve_fixed_code_and_audit(user):
    ...
    assert toggled.code == DiaryOption.FixedCode.MOOD_HAPPY
