...
def seed_locations(apps, schema_editor):
    State = apps.get_model("addresses", "State")
    City = apps.get_model("addresses", "City")
    state_manager = State._base_manager
    city_manager = City._base_manager

    data_path = Path(__file__).resolve().parents[2] / "locations" / "data" / "brazil_locations.json"
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("addresses", "0004_alter_address_state_state_city_and_more"),
    ]
